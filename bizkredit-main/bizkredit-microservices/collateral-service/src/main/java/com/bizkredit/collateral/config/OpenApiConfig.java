...
// Configuration class for Swagger OpenAPI documentation - Collateral Service
@Configuration
public class OpenApiConfig {
    ...
    public OpenAPI collateralServiceOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("BizKredit - Collateral Service")
                        .description("Collateral, Facility, Disbursement & Repayment microservice")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("BizKredit Team")
