...
import com.bizkredit.monitoring.enums.ApplicationStatus;
...
// sme-loan-service. monitoring-service reads this transitively through
// FacilityAccount.application (EntityGraph paths for covenant/EWS lookups).
@Entity
