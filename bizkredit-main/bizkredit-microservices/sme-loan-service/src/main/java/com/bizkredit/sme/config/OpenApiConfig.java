...
// Configuration class for Swagger OpenAPI documentation - SME Loan Service
@Configuration
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI smeLoanServiceOpenAPI() {
        return new OpenAPI()

                // Basic API metadata shown in Swagger UI
                .info(new Info()
                        .title("BizKredit - SME Loan Service")
                        .description("SME Onboarding & Loan Origination microservice")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("BizKredit Team")
