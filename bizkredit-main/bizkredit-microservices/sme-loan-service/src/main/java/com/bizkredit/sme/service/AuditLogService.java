...
// The method signature is kept identical to the original monolith's AuditLogService
// so callers (SMELoanService, LoanProductService) did not need to change.
@Slf4j
@Service
public class AuditLogService {

    public void log(Long userId, String action, String entityType, String recordId) {
        log.info("AUDIT [sme-loan-service] userId={} action={} entityType={} recordId={}",
