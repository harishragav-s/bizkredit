...
// Configuration class for Swagger OpenAPI documentation - Monitoring Service
@Configuration
public class OpenApiConfig {
    ...
    public OpenAPI monitoringServiceOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("BizKredit - Monitoring Service")
                        .description("Covenant & Portfolio Monitoring, NPA Classification, Notifications microservice")
                        .version("1.0.0")
                        .contact(new Contact()
                                .name("BizKredit Team")
