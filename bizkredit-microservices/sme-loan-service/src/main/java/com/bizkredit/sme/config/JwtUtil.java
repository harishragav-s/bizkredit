...
public class JwtUtil {
    ...
    // Short-lived token for internal service-to-service calls that must
    // succeed regardless of the triggering user's own role (e.g. creating
    // a notification is a system-level side effect, not something that
    // should require the caller to personally hold ADMIN).
